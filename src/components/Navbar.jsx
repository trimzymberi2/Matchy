  ...
  return (
    <div className='md:flex pt-5 w-full sticky md:justify-between md:items-center '>
        ...
        <div className=' md:opacity-100 hidden md:flex md:flex-row lg:gap-16 gap-8 text-primary'>
                <h4 className='text-xl hover:text-primaryshadow hover:cursor-pointer'>HOME</h4>
                <h4 className='text-xl hover:text-primaryshadow hover:cursor-pointer'>GARDEROBE</h4>
                <h4 className='text-xl hover:text-primaryshadow hover:cursor-pointer'>OUTFIT</h4>
        </div>
        <img src={icon} onClick={toggleNavbar} alt="" className='hover:cursor-pointer h-10 md:hidden absolute top-5 right-0'/>
        <div className='flex items-center gap-5'>
            <button className='w-24 hover:bg-primaryshadow h-10 md:flex md:items-center md:justify-center hidden bg-primary rounded-lg text-white'>
              Log in
            </button>
        </div>
        {isOpen && (
